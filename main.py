...
def show_main_page():
    ...
    with st.expander("Hypothesis", expanded=True):
        ...
        st.write("The box plot displays the distribution of selling prices for petrol cars with automatic transmissions categorized by seller type: Individual, Dealer, and Trustmark Dealer."
...
"The statistical test results (t-statistic = 6.55, p-value = 0.0000) confirm the hypothesis that petrol cars with automatic transmission sold by dealers have higher prices than those sold by individuals, 
